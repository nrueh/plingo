...
from utils import lit, calculate_weight
...
def convert_sort(theory_atom):
    ...
    asp_rules = [sort_fact, meta_to_readable]
...
def convert_prob_atom(pratom, body):
    loc = pratom.location
    ...
    meta_attr = ast.Function(loc, 'attribute',
                             [name_func, domain_func, range_sort], False)
    pratom = ast.Function(loc, 'pratom', [random_identifier, meta_attr, prob],
                          False)
    # print(pratom)
